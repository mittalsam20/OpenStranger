...
const socket = io("https://strangermeet.herokuapp.com/");
...
const App = () => {
    ...
    return ( <
        ...
        alt = "Logo" / >
        <
        div className = "app-name b-500 primaryColor" > Let 's Meet</> <
        /header> <
        div className = "chat-system" >
        <
        div className = "chat-box" > { /* Ask User Name or email */ } {
            step === 0 && ( <
        ...
        { /* select user and switch to chat window */ } {
            step === 2 && ( <
                MessagesControl sendMessage = { sendMessage }
                value = { message }
                receiver = { receiver }
